...
$respuestaCliente = ControllerClientes::ControladorMostrarClientes($itemCliente, $valorCliente);
...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="images/l.png"></td>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					Teléfono: 502 30 46 48 59
					
					<br>
					infoxelacode@gmail.com
